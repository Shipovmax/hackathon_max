...
С одним токеном `run_bot` должен работать **только у одного человека одновременно**: параллельные Long Polling перехватывают события друг у друга.
...
| `Dockerfile`, `compose.yaml` | сборка и запуск | написаны, ещё не проверены |
...
- Сборка Docker и встраивание мини-приложения в веб-версию MAX ещё не проверены.
